...
13. เพิ่มโค้ดในเรียกใช้ไลบรารี ADC ของ ESP32 
...
14. เพิ่มโค้ดในการกำหนด

- analogtxt เป็นตัวแปรแบบข้อความที่จะใช้เก็บค่าข้อมูลที่สร้างด้วย sprintf และส่งไปยังผู้ใช้ผ่าน HTTP Response
  
- adc_raw เป็นตัวแปรแบบจำนวนเต็มที่ใช้เก็บข้อมูล raw data ที่ได้จากการอ่านค่า ADC
...
15. เพิ่มโค้ดในการส่งข้อมูลใน analogtxt ไปยังผู้ใช้ผ่าน HTTP Server
...
โค้ดในไฟล์ main.c ที่แก้ไขแล้ว
...
17. เลือก Build Flash and Monitor

## ผลลัพท์ 

18. Serial Moniter จะแสดง IP address

19. นำ IP address ที่ได้ไปกรอกใน google
